...
async function getForPost(Workout_id){
    const sql = `SELECT P.*, FirstName, LastName FROM FITAPP_Comments P Join FITAPP_Users U ON P.Owner_id = U.id WHERE P.Workout_id = ?`
...
module.exports = {getAll, get,add,update,remove, getForPost}